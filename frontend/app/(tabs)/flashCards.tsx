...
import { StyleSheet, Button, View, TouchableOpacity, Image, ScrollView } from 'react-native';
...
export default function TabTwoScreen() {
  ...
  return (
    <TouchableOpacity onPress={() => setFlipped(!flipped)} style={{flex: 1}}>
      <ScrollView style={styles.container} contentContainerStyle={containerStyles.wrapper} >
